...
import { TbBalloonOff } from 'react-icons/tb';  // Ensure you import this correctly
...
function Song() {
  ...
  const timeHandlerFunction = (e) => {
    ...
    const timerchang = Math.floor(e.target.currentTime);
    setTimer(formatTime(timerchang));
  };
      ...
      <div className="song-container">
        ...
        <div className='input-name'>
          <input
            type="range"
            value={currentTime}
            max={audioRef.current?.duration || 100}  // Ensure max is always set
